...
fn doctor_ip(server_ip_address: std::net::IpAddr, server_address: Option<&str>) {
    ...
    doctor_tcp(server_ip_address, "20114", "API");
    doctor_tcp(server_ip_address, "20115", "hbbs extra port for nat test");
    doctor_tcp(server_ip_address, "20116", "hbbs");
    doctor_tcp(server_ip_address, "20117", "hbbr tcp");
    doctor_tcp(server_ip_address, "20118", "hbbs websocket");
    doctor_tcp(server_ip_address, "20119", "hbbr websocket");
